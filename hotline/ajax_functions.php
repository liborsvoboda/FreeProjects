...
if (isset($_GET["tpv_header_info"])){
    ...
    $sum_table[0]=array(dictionary("nomenklatura",$_SESSION["language"]),dictionary("total",$_SESSION["language"]),dictionary("total_net_quantity",$_SESSION["language"]));
...
if ($search=="L"){
  ...
  for ($i = 0; $i < count($datalist_array); $i++) {
     if($datalist_array[$i][1] == "NO" ) {
        ...
        $previous_net_count=$datalist_array[$i][22];
        $search="D";
        break;         
     }
  }
...
$cykl=0;while($cykl < @count($datalist_array)):
 ...
 if ($cykl==0){ // column names
    $data_temp.="<tr style=font-size:8px;background-color:#98D1FF; ><td><img src=./images/add.png id=main_image onclick=run_functs(this.field_list); style=width:12px;cursor:pointer;vertical-text-align:middle; />".$datalist_array[$cykl][3]."</td><td>".$datalist_array[$cykl][1]."</td><td>".$datalist_array[$cykl][5]."</td><td>".$datalist_array[$cykl][9]."</td><td>".$datalist_array[$cykl][8]."</td><td>".$datalist_array[$cykl][4]."</td><td>".$datalist_array[$cykl][6]."</td><td>".$datalist_array[$cykl][17]."</td><td>".$datalist_array[$cykl][7]."</td><td>".$datalist_array[$cykl][15]."</td><td>".$datalist_array[$cykl][16]."</td><td>".$datalist_array[$cykl][18]."</td><td>".$datalist_array[$cykl][10]."</td><td>".$datalist_array[$cykl][11]."</td><td>".$datalist_array[$cykl][12]."</td><td>".$datalist_array[$cykl][13]."</td><td>".$datalist_array[$cykl][14]."</td><td></td><td></td><td></td><td>".$datalist_array[$cykl][19]."</td><td>".$datalist_array[$cykl][20]."</td></tr>";
    }
        ...
        if ($datalist_array[$cykl][2]==0){
            ...
            $data_temp.="<td>".$datalist_array[$cykl][20]."</td><td>".$datalist_array[$cykl][10]."</td><td>".$datalist_array[$cykl][11]."</td><td>".$datalist_array[$cykl][12]."</td><td>".$datalist_array[$cykl][13]."</td><td>".$datalist_array[$cykl][14]."</td><td>".$datalist_array[$cykl][18].";".$datalist_array[$cykl][19]."</td><td>".$cykl."</td><td>".$datalist_array[$cykl][0]."</td><td>".@number_format($datalist_array[$cykl][21],4,","," ")."</td><td>".@number_format($datalist_array[$cykl][22],4,","," ")."</td></tr>";
                                    
            if ($datalist_array[$cykl][0]=="D"){    $data_temp.="<tr><td colspan=22 id=\"".$datalist_array[$cykl][19]."\" style=\"display:none;width:100%;\" ></td></tr>";}
        } else { //more levels
            ...
            $include_script_objects.="<td>".$datalist_array[$cykl][20]."</td><td>".$datalist_array[$cykl][10]."</td><td>".$datalist_array[$cykl][11]."</td><td>".$datalist_array[$cykl][12]."</td><td>".$datalist_array[$cykl][13]."</td><td>".$datalist_array[$cykl][14]."</td><td>".$datalist_array[$cykl][18].";".$datalist_array[$cykl][19]."</td><td>".$cykl."</td><td>".$datalist_array[$cykl][0]."</td><td>".@number_format($datalist_array[$cykl][21],4,","," ")."</td><td>".@number_format($datalist_array[$cykl][22],4,","," ")."</td></tr>";

            if ($datalist_array[$cykl][0]=="D"){$include_script_objects.="<tr><td colspan=22 id=\"".$datalist_array[$cykl][19]."\" style=\"display:none;width:100%;\" ></td></tr>";}
    ...
    $founded=0;$search_cycle=0;while($search_cycle<@count(@$sum_table)):
        if ($founded==0 && @$sum_table[@$search_cycle][0]==$datalist_array[$cykl][4]){$founded=1;
            @$sum_table[@$search_cycle][1]=(float) @$sum_table[@$search_cycle][1] +(float) $datalist_array[$cykl][17];@$sum_table[@$search_cycle][2]=(float) @$sum_table[@$search_cycle][2] +(float) $datalist_array[$cykl][22];
        }
        if ($search_cycle==(@count(@$sum_table)-1) && $founded==0){$founded=1;
             array_push($sum_table, array($datalist_array[$cykl][4],(float)$datalist_array[$cykl][17],(float)$datalist_array[$cykl][22]));
...
$search_cycle=0;while($search_cycle<@count(@$sum_table)):
    if ($search_cycle==0){$total_table.="<tr style=font-size:12px;vertical-text-align:middle;background-color:#98D1FF; ><td>".@$sum_table[@$search_cycle][0]."</td><td style=align:right; >".@$sum_table[@$search_cycle][1]."</td><td style=align:right; >".@$sum_table[@$search_cycle][2]."</td></tr>";}
    else {$total_table.="<tr style=font-size:12px;vertical-text-align:middle;background-color:#98D1FF; ><td>".@$sum_table[@$search_cycle][0]."</td><td>".@number_format(@$sum_table[@$search_cycle][1],4,","," ")."</td><td>".@number_format(@$sum_table[@$search_cycle][2],4,","," ")."</td></tr>";}
$search_cycle++;endwhile;
$total_table.="</table>";
